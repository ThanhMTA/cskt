...
import { createHangSX, removeHangSX, updateHangSX } from "../store/HangSX.action";
...
type HangSXActionType = {
  action: Action;
  detail?: HangSXData;
};
const HangSXAction: React.FC<HangSXActionType> = ({
  action,
  detail,
}) => {
  ...
  const onFinish = async () => {
    try {
      ...
      switch (action) {
        case Action.Update:
          await updateHangSX(detail?.id, value);
          openMessage({
            type: "success",
