                                    ...
                                    if (e.target.value !== '') {
                                        const newFilter = {
                                            ...
                                            _or: [
                                                ...
                                                { condition_id: { name: { _icontains: e.target.value } } },
                                                { investor_id: { name: { _icontains: e.target.value } } },
                                                { manufacturer_id: { name: { _icontains: e.target.value } } },
                                                { unit_id: { name: { _icontains: e.target.value } } },
                                                { org_id: { name: { _icontains: e.target.value } } },
                                                { place_id: { name: { _icontains: e.target.value } } },
                                                { species_id: { name: { _icontains: e.target.value } } },
                                                { group_id: { name: { _icontains: e.target.value } } },
                                                { manager_id: { name: { _icontains: e.target.value } } },
                                            ],
                                        };
                                        ...
                                        setFilterHandover({
                                            ...
                                            _or: [
                                                { name: { _icontains: e.target.value } },
                                                { title: { _icontains: e.target.value } },
                                                // { org_delivery_id: { _icontains: e.target.value } },
                                                { type_handover: { _icontains: e.target.value } },
                                                // { quantity: { _icontains: e.target.value } },
                                                { org_delivery_id: { name: { _icontains: e.target.value } } },
                                                { org_receive_id: { name: { _icontains: e.target.value } } },
                                                // { org_id: { name: { _icontains: e.target.value } } },
                                                // { place_id: { name: { _icontains: e.target.value } } },
                                            ],
                                        });
