...
var NoStyleItemContext = React9.createContext(null);
var FormProvider2 = (props) => {
  const providerProps = omit(props, ["prefixCls"]);
  return React9.createElement(FormProvider, Object.assign({}, providerProps));
};
var FormItemPrefixContext = React9.createContext({
  prefixCls: ""
});
var FormItemInputContext = React9.createContext({});
if (true) {
...
var NoFormStyle = (_ref) => {
  ...
  const formItemInputContext = React9.useContext(FormItemInputContext);
  const newFormItemInputContext = React9.useMemo(() => {
  ...
  return React9.createElement(FormItemInputContext.Provider, {
    value: newFormItemInputContext
  }, children);
};
var VariantContext = React9.createContext(void 0);
...
var fullClone = Object.assign({}, React12);
var {
  useId
} = fullClone;
var useEmptyId = () => "";
...
var useVariant = function(component, variant) {
  ...
  const ctxVariant = React16.useContext(VariantContext);
...
var CompactItem = (props) => {
  ...
  return React17.createElement(SpaceCompactItemContext.Provider, {
    value: React17.useMemo(() => others, [others])
  }, children);
};
var Compact = (props) => {
  const {
...
var useHandleResizeWrapper = () => {
  const handleResizeWrapper = import_react9.default.useCallback((rcTextArea) => {
    if (!rcTextArea) {
      return;
    }
...
var Input = (0, import_react12.forwardRef)((props, ref) => {
  ...
  if (true) {
    ...
    (0, import_react12.useEffect)(() => {
      ...
      if (inputHasPrefixSuffix && !prevHasPrefixSuffix.current) {
        true ? warning2(document.activeElement === ((_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.input), "usage", `When Input is focused, dynamic add or remove prefix / suffix will make it lose focus caused by dom structure change. Read more: https://ant.design/components/input/#FAQ`) : void 0;
      }
  ...
  return wrapSharedCSSVar(wrapCSSVar(import_react12.default.createElement(es_default, Object.assign({
...
var TextArea = (0, import_react13.forwardRef)((props, ref) => {
  ...
  const {
    ...
    variant: customVariant,
    showCount
  } = props, rest = __rest6(props, ["prefixCls", "bordered", "size", "disabled", "status", "allowClear", "classNames", "rootClassName", "className", "style", "styles", "variant", "showCount"]);
  if (true) {
    const {
      deprecated
  ...
  const disabled = React21.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
  ...
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  const innerRef = React21.useRef(null);
  ...
  return wrapSharedCSSVar(wrapCSSVar(React21.createElement(es_default2, Object.assign({
    autoComplete: contextAutoComplete
  }, rest, {
    style: Object.assign(Object.assign({}, contextStyle), style),
    styles: Object.assign(Object.assign({}, contextStyles), styles),
    disabled: mergedDisabled,
    allowClear: mergedAllowClear,
    className: (0, import_classnames4.default)(cssVarCls, rootCls, className, rootClassName, compactItemClassnames, contextClassName),
    classNames: Object.assign(Object.assign(Object.assign({}, classes), contextClassNames), {
    ...
    prefixCls,
    suffix: hasFeedback && React21.createElement("span", {
...
//# sourceMappingURL=chunk-YSV474JE.js.map
